...
class SphereTests {
    ...
    /***
     * Testers for sphere find intersections
     */
    @Test
    public void testFindIntersections() {
        ...
        assertEquals(List.of(new Point(2, 0, 0)), sphere.findIntersections(new Ray(new Point(0.5, 0, 0), new Vector(1, 0, 0))), "Ray starts inside the sphere");
        ...
        assertEquals(List.of(new Point(1, 0.5, 0.8660254037844386)), sphere.findIntersections(new Ray(new Point(1, 0.5, -0.5), new Vector(0, 0, 1))), "Ray starts at sphere and goes inside");
        ...
        assertEquals(List.of(new Point(0, 0, 0)), sphere.findIntersections(new Ray(new Point(2, 0, 0), new Vector(-1, 0, 0))), "Ray starts at spheres and go inside");

        // TC15: Ray starts inside (1 point)
        assertEquals(List.of(new Point(0, 0, 0)), sphere.findIntersections(new Ray(new Point(.5, 0, 0), new Vector(-1, 0, 0))), "Ray starts inside and goes out");

        // TC16: Ray starts at the center (1 point)
        //  assertEquals(List.of(new Point(2.0, 0.0, 0.0)), sphere.findIntersections(new Ray(new Point(1, 0, 0), new Vector(2, 0, 0))), "Ray starts at sphere and goes inside");
        ...
        // Ray's line is tangent to the sphere (all tests 0 points)
